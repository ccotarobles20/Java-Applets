...
public abstract class BufferedApplet extends java.applet.Applet implements Runnable, KeyListener, MouseListener, MouseMotionListener
{
   ...
   public void init()
   {
	   drawLord = getImage(getCodeBase(), "Lord.gif");
	   drawArcher = getImage(getCodeBase(), "Archer.gif");
	   drawSwordsman = getImage(getCodeBase(), "Swordsman.gif");
	   
	   drawEnemySwordsman = getImage(getCodeBase(), "EnemySwordsman.gif");
	   drawEnemyDemon = getImage(getCodeBase(), "EvilDemon.gif");
	   
	   fence = getImage(getCodeBase(), "Fence.gif");
	   mountains = getImage(getCodeBase(), "Mountains.gif");
	   sandbox = getImage(getCodeBase(), "Sandbox.gif");
   }
