...
public abstract class BufferedApplet extends java.applet.Applet implements Runnable, KeyListener, MouseListener, MouseMotionListener
{
   ...
   Image drawEnemySwordsman;
   Image drawEnemyDemon;
   ...
   public void init()
   {
	   drawArcher = getImage(getCodeBase(), "pieces\\Archer.gif");
	   drawSwordsman = getImage(getCodeBase(), "pieces\\Swordsman.gif");
	   
	   drawEnemySwordsman = getImage(getCodeBase(), "pieces\\EnemySwordsman.gif");
	   drawEnemyDemon = getImage(getCodeBase(), "pieces\\EvilDemon.gif");
	   
	   fence = getImage(getCodeBase(), "pieces\\Fence.gif");
	   mountains = getImage(getCodeBase(), "pieces\\Mountains.gif");
	   sandbox = getImage(getCodeBase(), "pieces\\Sandbox.gif");
   }
   ...
   public void update(Graphics g) {
      if (r.width != getWidth() || r.height != getHeight())
      {
         ...
         bufferGraphics = bufferImage.getGraphics(); // Applet size change.
  	   	 drawLord = getImage(getCodeBase(), "pieces\\Lord.gif");
	 r.width  = getWidth();
	 r.height = getHeight();
